...
public class Juego {
    ...
    public Juego(String id, String player1, String player2, int scorep1, int scorep2, int score_ignorancia, boolean turno, String id_p1, String id_p2,String currentUser) {
